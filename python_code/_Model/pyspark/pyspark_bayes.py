...
def evaluate_classifier(params):
    ...
    train_data, val_data, test_data = df.randomSplit([0.9, 0.05, 0.05], seed=37)
    ...
    cv = CrossValidator(estimator=clf, estimatorParamMaps=paramGrid, evaluator=evaluator, numFolds=5, seed=37)
